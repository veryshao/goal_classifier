"""
Predict + bootstrap-label new transcripts using the OpenAI embedding pipeline.

Loads the saved LogisticRegression classifier from results/embed_model/,
embeds each utterance via text-embedding-3-large (cached), builds windowed
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Predict goal conversation labels using the OpenAI embedding pipeline."
    )
    parser.add_argument(
